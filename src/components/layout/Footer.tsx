    ...
    <footer className="bg-navy-950 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-8 border-b border-navy-800">
          <div>
            <h3 className="text-2xl font-semibold mb-4">
              RevenuePro<span className="text-revenue-400">.</span>
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin className="h-5 w-5 mr-2 text-revenue-400 flex-shrink-0 mt-0.5" />
                <span className="text-gray-300">
                  123 Business Avenue, San Francisco, CA 94111
                </span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 mr-2 text-revenue-400 flex-shrink-0" />
                <a href="tel:+14155552671" className="text-gray-300 hover:text-white transition-colors">
                  (415) 555-2671
                </a>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 mr-2 text-revenue-400 flex-shrink-0" />
                <a href="mailto:info@revenuepro.com" className="text-gray-300 hover:text-white transition-colors">
                  info@revenuepro.com
                </a>
              </li>
            </ul>
        ...
        <div className="pt-8 text-center text-gray-400 text-sm">
          <p>&copy; {currentYear} RevenuePro. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
